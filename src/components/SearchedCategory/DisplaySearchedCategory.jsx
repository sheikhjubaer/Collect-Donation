...
const DisplaySearchedCategory = ({ data }) => {
    const { id, picture, title, category, color_card_bg, color_text, color_button_background, description, price } = data;
...
export default DisplaySearchedCategory;